  ...
  return (
    <div className="donaciones">
      ...
      <div className="donacionesDivLogo">
        <a href="https://www.mercadopago.com.ar/hub/registration/landing" target="_blank" rel="noreferrer">
          <img src={logoMP} alt="Logo de Mercado Pago" className="donacionLogo" />
        </a>
      </div>
      <div className="donacionesDivButton">
        <a href="https://link.mercadopago.com.ar/guidomartin7" target="_blank" rel="noreferrer">
          <button className="donacionesButton" type="submit">
            Donar una vez
          </button>
        </a>
        <a href="https://www.mercadopago.com.ar/subscriptions/checkout?preapproval_plan_id=2c938084880a270801880b2f50f5005e" target="_blank" rel="noreferrer">
          <button className="donacionesButton" type="submit">
            Donacion mensual
          </button>
        </a>
