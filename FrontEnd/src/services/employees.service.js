...
const getAllEmployees = () => {
  return axios.get("http://localhost:8080/api/v1/manager/getAllEmployees", {
    headers: authHeader(),
    method: "GET",
...
const validateEmployee = (employeeId) => {
  ...
  return axios
    .put("http://localhost:8080/api/v1/manager/validateEmployee", data, {
      headers: authHeader(),
      "Content-Type": "application/json",
    })
    .then((response) => {
...
const validateAdmin = (employeeId) => {
  ...
  return axios
    .put(`http://localhost:8080/api/v1/admin/validateAdmin`, data, {
      headers: authHeader(),
      "Content-Type": "application/json",
    })
    .then((response) => {
