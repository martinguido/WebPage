...
public class InitialConfiguration {
    ...
    @Bean
    public CommandLineRunner commandLineRunner(AuthenticationService authenticationService, UserRepository userRepository, RequestService requestService, SubscriberService subscriberService) {
        return args -> {
            ...
            addSampleRequests(requestService);
            addSampleSubscribers(subscriberService);
        };
    }

    private void addSampleRequests(RequestService requestService) throws ParseException {
    ...
    private void addSampleSubscribers(SubscriberService subscriberService) throws ParseException {
        SimpleDateFormat format = new SimpleDateFormat("yyyy-MM-dd");
