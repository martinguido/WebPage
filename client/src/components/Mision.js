    ...
    <section className="secMision">
      <div className="mision1">
        ...
        <p className="misionText1">
          Nuestra organización tiene como objetivo principal la reforestación y
          restauración de áreas degradadas y deforestadas en todo el mundo,
      ...
      <div className="mision2">
        ...
        <p className="misionText2">
          ...
          trabajando en todo el mundo para impulsar la transformación hacia una
          economía verde y sostenible. Nuestro trabajo es fundamental para
          reducir la huella de carbono de la humanidad y mitigar los efectos del
          cambio climático.
        </p>
        <p className="misionText2">
